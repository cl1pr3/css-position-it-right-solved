...
- [1 ] Animation with rotation is shown.
- [1 ] Animation with disappearing/appearing is shown.
- [1 ] Animation with changing dimensions is shown.
- [1 ] Animation with movement around some position is shown.
- [1 ] Animation on object hover event is shown.
- [1 ] Animation with color changing is shown.
- [1 ] Every facial feature item except for the face shape is animated.
